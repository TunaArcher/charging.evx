...
function getInfoWindowContent(location, marker) {
  ...
  const markerHeader = `
        <div class="info-header p-3">
            ...
            ${_imgDiv}
            <div class="row">
                <div class="col-12 mt-2 mb-2 pe-0">
                    ...
                    ${btnCall}
                    <a href="${googleMapsUrl}" target="_blank" class="btn btn-outline-primary btn-sm" title="นำทาง"><i class="fas fa-directions"></i></a>
                    ...
                    <div class="row">
                        <div class="col-12">
                           ${btnWebsite}${btnIot}${btnCall}${btnIssueReport}
                            <a href="${googleMapsUrl}" target="_blank" class="btn btn-outline-primary btn-sm" title="นำทาง"><i class="fas fa-directions"></i> <span class="small">นำทาง<span></a>
