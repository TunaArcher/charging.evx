    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center mb-7">
                    <h3 class="fw-semibold">ปัญหาที่พบบ่อย</h3>
                    <p class="fw-normal mb-0 fs-4">EVX</p>
                </div>
        ...
        <div class="card bg-primary-subtle rounded-2">
            <div class="card-body text-center">
                ...
                <p class="fw-normal text-primary mb-4 fs-4">Can't find the answer your're looking for ? Please chat to our friendly</p>
                <a href="javascript:void(0)" class="btn btn-primary mb-8" onclick="alert('In Development');">Chat with us</a>
            </div>
        </div>
    </div>
</div>